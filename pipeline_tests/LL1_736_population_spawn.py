...
generate_pipeline(primitive_name='d3m.primitives.feature_construction.deep_feature_synthesis.SingleTableFeaturization',
              pipeline_description = pipeline_description,
              dataset_name='LL1_736_population_spawn')
